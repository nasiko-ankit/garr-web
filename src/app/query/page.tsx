...
import { ApiError, getIndexRecord, searchIndexRecords, resolveAgent, fetchAgentRecord } from "@/lib/garr-api";
import type { IndexRecord, SearchResponse, ResolveResponse, CatalogEntry } from "@/lib/garr-types";
