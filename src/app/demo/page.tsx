...
import type { ResolveResponse, CatalogEntry } from "@/lib/garr-types";
...
export default function DemoPage() {
  ...
  async function onResolve(e: React.FormEvent) {
    ...
    // Hop 1 — NANDA Index
    const h1url = `${process.env.NEXT_PUBLIC_GARR_API_BASE_URL ?? "http://localhost:3001"}/api/v1/resolve?locator=${encodeURIComponent(locator.trim())}`;
    setHop1Url(h1url);
